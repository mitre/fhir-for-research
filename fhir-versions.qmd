...
>  is considered to be stable and has been 'locked', subjecting it to FHIR [Inter-version Compatibility Rules](https://www.hl7.org/fhir/versions.html#change). While changes are possible, they are expected to be infrequent and are tightly constrained. ([source](https://www.hl7.org/fhir/R5/versions.html#std-process))

Other resources, like [NutritionProduct](https://www.hl7.org/fhir/R5/nutritionproduct.html) have a much lower maturity level even in the R5 release. These resources are likely to experience more significant changes -- including breaking changes -- in subsequent releases of FHIR.
