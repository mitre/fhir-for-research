...
-   [Real World Example](/modules/new-cds-hooks-real-world-example.qmd)
-   [Technical Details](/modules/new-cds-hooks-tech.qmd)
-   [Use Case Exercise](/modules/new-use-case-example.qmd)
