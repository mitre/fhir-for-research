...
-   You can contribute ("upstream") your changes from your fork to the NIH/ODSS-managed open source GitHub repository
    ...
    -   NIH/ODSS will review to integrate into the main repository
:::
...
-   Include learning objectives and prerequisites in registration promotional materials
    ...
    -   Consider the Introduction to FHIR for Research webinar as a prerequisite if your potential audience doesn't have prior FHIR experience (<https://purl.org/fhir-for-research/webinars/intro>)
