...
If you are interested in running your own workshop, the following recommendations may be useful. These are based on NIH/ODSS's experience conducting the [FHIR Bulk Data Access](../bulk-data/index.qmd) and [SMART on FHIR](../smart-on-fhir/index.qmd) workshops.
...
-   [Accessible PDF](Webinar - Workshop Recommendations 508C.pdf)
...
If you don't want to run a server, there are a number of different services you can use. Two of these are:
    -   Free, some additional complexity: <https://mybinder.org>
    -   $15/month, more reliable: <https://posit.cloud/plans/instructor?option=instructor>
...
Using synthetic data for workshops avoids privacy issues with patient data. [Synthea](https://synthea.mitre.org) provides synthetic data in FHIR format, and [additional information is here](../../sections/advanced-topics.qmd#synthetic-data-fhir-testing-servers).
