...
If you are interested in running your own workshop, the following recommendations may be useful. These are based on NIH/ODSS's experience conducting the [FHIR Bulk Data Access](../bulk-data/index.qmd) and [SMART on FHIR](../../workshops/smart-on-fhir/index.qmd) workshops.
