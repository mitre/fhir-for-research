...
3.  Recommendations for live workshops
    1.  Compute environment & synthetic data
...
-   Consider a brief pre-survey or lightweight capability assessment
    -   <https://purl.org/fhir-for-research/web/workshop-recommendations> has more information
...
\[Demo Synthea customizer tool here\]
:::
...
\[Walk through of Logica\]
:::

::: notes
Walk through <https://sandbox.logicahealth.org/FHIRResearchSynthea/apps>
:::
...
-   Materials from this workshop: <https://purl.org/fhir-for-research/workshops/workshop-recommendations>
