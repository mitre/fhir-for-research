...
Prior to developing the self-paced learning resources, webinars, and workshops on this site, a capability assessment was completed to evaluate the current knowledge and usage of FHIR for research at the selected IDeA-CTRs. A capability assessment is a structured approach for identifying the current level of understanding and skill sets relating to a topic.

### Why complete a capability assessment?
...
1.  Select a representative sample of people to connect with. Speak with a broad representation of sites that may participate in the training like rural and urban sites, academic medical centers, community practice networks with small office practices, patient demographics, and research areas of interest. Including many types of sites and CTR-members will help to tailor training content and delivery to meet the needs of the CTR community.
...
2.  Use a variety of outreach methods. The capability assessment completed before developing this course content used three methods to connect with the selected CTRs:
...
4.  Meet participants at their level of interest and engagement. Not all training participants will need the same level of knowledge about FHIR. When developing training resources, the content was designed to be approachable for people from many backgrounds. Then as the modules continued, the content became more technical and detailed.
...
-   Write survey questions if using a written format or structured interview. The [capability assessment questions](capability-assessment-survey.pdf) used for developing this course content are available as a guide
...
There are two curriculum development models, ADDIE and SAM, that may be helpful frameworks for writing new modules or developing workshops. 
...
-   NIH-funded researchers can use <https://cloud.nih.gov> to run VMs from public cloud vendors (AWS, Azure, GCP) at a discounted price :::
