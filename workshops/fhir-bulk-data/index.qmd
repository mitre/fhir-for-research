...
The materials for this workshop are in a Jupyter notebook. You can access the notebook [as part of this website](notebook.html), or via the [raw `.ipynb` file](https://github.com/mitre/fhir-for-research/blob/main/workshops/fhir-bulk-data/notebook.ipynb) ([open in nbviewer](https://nbviewer.org/github/mitre/fhir-for-research/blob/main/workshops/fhir-bulk-data/notebook.ipynb)).
