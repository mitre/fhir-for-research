...
# Introduction to FHIR Bulk Data {background-image="NIH_slide_background.png" background-size="100vw 100vh" background-color="#20558A"}
...
-   FHIR Bulk Data [`group-export`](https://hl7.org/fhir/uv/bulkdata/OperationDefinition-group-export.html) required for <mark>December 2022</mark> certification deadline for USCDI data elements
...
1.  Technical overview of example FHIR Bulk Data workflow (slides)
2.  Hands-on in a Jupyter Notebook with Python:
    1.  Setup and dependencies
    2.  Retrieving a Bulk Data export
    3.  Analyzing FHIR-format data
3.  Optional lab
