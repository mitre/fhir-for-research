...
The `requirements.txt` file you need is [here](https://github.com/mitre/fhir-for-research/blob/main/requirements.txt) if you can't easily access your clone of the repo.
