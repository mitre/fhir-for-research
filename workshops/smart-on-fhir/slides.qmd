...
# SMART on FHIR<sup>®</sup> Workshop {background-image="NIH_slide_background.png" background-size="100vw 100vh" background-color="#20558A"}
...
-   Access [Bulk Data](../fhir-bulk-data/index.html)
...
<small><a href="https://mitre.github.io/fhir-for-research/workshops/smart-on-fhir/" target=_blank>view</a></small>

## Basic sample app

::: r-fit-text
-   Source: <https://github.com/mitre/smart-on-fhir-demo>
-   Explanation: <https://mitre.github.io/fhir-for-research/modules/smart-on-fhir-tech>
-   Options for accessing sample app:
    -   Should be running on `http://localhost:3000` for you
    -   Also available at <https://mitre.github.io/smart-on-fhir-demo>
...
You can copy file contents from <https://github.com/mitre/smart-on-fhir-demo>.
...
-   But it can be helpful to have an open testing server (with synthetic data only!)
    -   [Synthea](https://mitre.github.io/fhir-for-research/modules/synthea-overview) synthetic data
...
-   "Playground" JavaScript:<br><https://github.com/mitre/smart-on-fhir-demo/blob/main/get_example.html>
:::
...
-   FHIR breaks up health information into chunks of data (**resources**) which are connected together via references
    -   More information: <https://mitre.github.io/fhir-for-research/modules/key-fhir-resources>
...
-   Review the spec to understand available data elements: <https://www.hl7.org/fhir/us/core/>
    -   How to read FHIR specs: <https://mitre.github.io/fhir-for-research/modules/data-modeling-reading-igs>
...
::: {style="color: black;"}
<https://forms.office.com/g/hYeUEvmgh1>
:::
...
-   [docs.smarthealthit.org](docs.smarthealthit.org) has:
    -   Tutorials
    -   Test environments
    -   Vendor sandboxes
    -   Sample apps
