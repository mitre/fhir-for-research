...
Resources are the key building blocks of FHIR. A [**FHIR resource**](https://healthit.gov/wp-content/uploads/2021/04/What-Is-FHIR-Fact-Sheet.pdf) is a structure that contains medical information in an unambiguous format. This allows different systems to understand information in the same way,[^1] which is necessary for health systems to accurately share data.
...
![The organization of FHIR's core resources. From <a href="https://hl7.org/fhir/R5">HL7's FHIR specification</a>.](images/fhir-index-R5.png){fig-alt="Screenshot from the FHIR specification showing the organization of FHIR resources. Level 1: basic framework on which the specification is built. Level 2: Supporting implementation and binding to external specifications. Level 3: Linking to real-world concepts in the healthcare system. Level 4: Record-keeping and and Data Exchange for the healthcare process. Level 5: Providing the ability to reason about the healthcare process."}

::: {.callout-note collapse="true" icon="false"}
## Links to the <a href="https://hl7.org/fhir/R5/">FHIR R5</a> resources in the screenshot above:

-   **Level 1** Basic framework on which the specification is built
    -   [Foundation](https://hl7.org/fhir/R5/foundation-module.html)
        -   [Base Documentation](https://hl7.org/fhir/R5/documentation.html)
        -   [XML](https://hl7.org/fhir/R5/xml.html)
        -   [JSON](https://hl7.org/fhir/R5/json.html)
        -   [RDF](https://hl7.org/fhir/R5/rdf.html)
        -   [Datatypes](https://hl7.org/fhir/R5/datatypes.html)
        -   [Extensions](https://hl7.org/fhir/R5/extensibility.html)
-   **Level 2** Supporting implementation and binding to external specifications
    -   [Implementer Support](https://hl7.org/fhir/R5/implsupport-module.html)
        -   [Downloads](https://hl7.org/fhir/R5/downloads.html)
        -   [Version Mgmt](https://hl7.org/fhir/R5/versioning.html)
        -   [Use Cases](https://hl7.org/fhir/R5/usecases.html)
        -   [Testing](https://hl7.org/fhir/R5/testing.html)
    -   [Security & Privacy](https://hl7.org/fhir/R5/secpriv-module.html)
        -   [Security](https://hl7.org/fhir/R5/security.html),
        -   [Consent](https://hl7.org/fhir/R5/consent.html),
        -   [Provenance](https://hl7.org/fhir/R5/provenance.html),
        -   [AuditEvent](https://hl7.org/fhir/R5/auditevent.html)
    -   [Conformance](https://hl7.org/fhir/R5/conformance-module.html)
        -   [StructureDefinition](https://hl7.org/fhir/R5/structuredefinition.html),
        -   [CapabilityStatement](https://hl7.org/fhir/R5/capabilitystatement.html),
        -   [ImplementationGuide](https://hl7.org/fhir/R5/implementationguide.html),
        -   [Profiling](https://hl7.org/fhir/R5/profiling.html)
    -   [Terminology](https://hl7.org/fhir/R5/terminology-module.html)
        -   [CodeSystem](https://hl7.org/fhir/R5/codesystem.html),
        -   [ValueSet](https://hl7.org/fhir/R5/valueset.html),
        -   [ConceptMap](https://hl7.org/fhir/R5/conceptmap.html),
        -   [Terminology Svc](https://hl7.org/fhir/R5/terminology-service.html)
    -   [Exchange](https://hl7.org/fhir/R5/exchange-module.html)
        -   [REST API](https://hl7.org/fhir/R5/http.html) + [Search](https://hl7.org/fhir/R5/search.html)
        -   [Documents](https://hl7.org/fhir/R5/documents.html)
        -   [Messaging](https://hl7.org/fhir/R5/messaging.html)
        -   [Services](https://hl7.org/fhir/R5/services.html)
        -   [Databases](https://hl7.org/fhir/R5/storage.html)
        -   [Subscriptions](https://hl7.org/fhir/R5/subscriptions.html)
-   **Level 3** Linking to real-world concepts in the healthcare system
    -   [Administration](https://hl7.org/fhir/R5/administration-module.html)
        -   [Patient](https://hl7.org/fhir/R5/patient.html)
        -   [Practitioner](https://hl7.org/fhir/R5/practitioner.html)
        -   [CareTeam](https://hl7.org/fhir/R5/careteam.html)
        ...
        -   [Healthcare Service](https://hl7.org/fhir/R5/healthcareservice.html)
-   **Level 4** Record-keeping and Data Exchange for the healthcare process
    -   [Clinical](https://hl7.org/fhir/R5/clinicalsummary-module.html)
        -   [Allergy](https://hl7.org/fhir/R5/allergyintolerance.html)
        -   [Problem](https://hl7.org/fhir/R5/condition.html)
        -   [Procedure](https://hl7.org/fhir/R5/procedure.html)
        -   [CarePlan](https://hl7.org/fhir/R5/careplan.html)/[Goal](https://hl7.org/fhir/R5/-%20goal.html)
        -   [Family History](https://hl7.org/fhir/R5/familymemberhistory.html)
        -   [RiskAssessment](https://hl7.org/fhir/R5/riskassessment.html)
        -   etc.
    -   [Diagnostics](https://hl7.org/fhir/R5/diagnostics-module.html)
        -   [Observation](https://hl7.org/fhir/R5/observation.html)
        -   [Report](https://hl7.org/fhir/R5/diagnosticreport.html)
        -   [Specimen](https://hl7.org/fhir/R5/specimen.html)
        -   [ImagingStudy](https://hl7.org/fhir/R5/imagingstudy.html)
        -   [Genomics](https://hl7.org/fhir/R5/genomics.html), etc.
    -   [Medications](https://hl7.org/fhir/R5/medications-module.html)
        -   [Medication](https://hl7.org/fhir/R5/medication.html),
        -   [Request](https://hl7.org/fhir/R5/medicationrequest.html)
        -   [Dispense](https://hl7.org/fhir/R5/medicationdispense.html),
        -   [Administration](https://hl7.org/fhir/R5/medicationadministration.html),
        -   [Statement](https://hl7.org/fhir/R5/medicationstatement.html),
        -   [Immunization](https://hl7.org/fhir/R5/immunization.html), etc.
    -   [Workflow](https://hl7.org/fhir/R5/workflow-module.html)
        -   [Introduction](https://hl7.org/fhir/R5/workflow.html) + [Task](https://hl7.org/fhir/R5/task.html)
        -   [Appointment](https://hl7.org/fhir/R5/appointment.html)
        -   [Schedule](https://hl7.org/fhir/R5/schedule.html)
        -   [Referral](https://hl7.org/fhir/R5/servicerequest.html)
        -   [PlanDefinition](https://hl7.org/fhir/R5/plandefinition.html), etc.
    -   [Financial](https://hl7.org/fhir/R5/financial-module.html)
        -   [Claim](https://hl7.org/fhir/R5/claim.html)
        -   [Account](https://hl7.org/fhir/R5/account.html),
        -   [Invoice](https://hl7.org/fhir/R5/invoice.html)
        -   [ChargeItem](https://hl7.org/fhir/R5/chargeitem.html),
        -   [Coverage](https://hl7.org/fhir/R5/coverage.html) + Eligibility
        -   [Request](https://hl7.org/fhir/R5/coverageeligibilityrequest.html) & [Response](https://hl7.org/fhir/R5/coverageeligibilityresponse.html)
        -   [ExplanationOfBenefit](https://hl7.org/fhir/R5/explanationofbenefit.html), etc.
-   **Level 5** Providing the ability to reason about the healthcare process
    -   [Clinical Reasoning](https://hl7.org/fhir/R5/clinicalreasoning-module.html)
        -   [Library](https://hl7.org/fhir/R5/library.html)
        -   [PlanDefinition](https://hl7.org/fhir/R5/plandefinition.html) & [GuidanceResponse](https://hl7.org/fhir/R5/guidanceresponse.html)
        -   [Measure](https://hl7.org/fhir/R5/measure.html)/[MeasureReport](https://hl7.org/fhir/R5/measurereport.html)
        -   etc.
    -   [Medication Definition](https://hl7.org/fhir/R5/medication-definition-module.html)
        -   [Medicinal](https://hl7.org/fhir/R5/medicinalproductdefinition.html)
        -   [Packaged](https://hl7.org/fhir/R5/packagedproductdefinition.html) & [Administrable](https://hl7.org/fhir/R5/administrableproductdefinition.html) product definitions
        -   [Regulated Authorization](https://hl7.org/fhir/R5/regulatedauthorization.html)
        -   etc.
:::
...
The [FHIR Maturity Model (FMM)](https://hl7.org/fhir/versions.html#maturity) describes how mature the definition of a particular FHIR resource type is. Each resource types has a maturity level from FMM 0 (draft) to FMM 6 (normative). As resource types receive more testing and become more stable, their FMM level increases, and in general, resource types with higher FMM levels are more likely to be implemented in real world systems. The FMM level for each resource type is displayed to the right of its name in the resource list, with `N` indicating normative.

::: callout-note
As of writing (March 2026), the FHIR R6 ballot indicates that the FMM framework may be revised. Once R6 is published, [this page](https://hl7.org/fhir/versions.html) will have any updates to the FMM framework.
:::

![Screenshot from the FHIR specification highlighting "Diagnostic" resource types along with their maturity level which range from 0 to normative (represented as <code>N</code>) (<a href="https://hl7.org/fhir/resourcelist.html">source</a>).](images/fmm-levels.png){fig-align="center" fig-alt="Screenshot from the FHIR specification highlighting 'Diagnostic' resource types along with their maturity level which range from 0 to normative."}

## Representation

A FHIR resource may be encoded in different standard formats like [JSON and XML](https://hl7.org/fhir/formats.html#wire). These formats are used throughout the software industry, not just in healthcare. Using standard formats allows common programming languages and software tools to process FHIR resources.[^2]

[^2]: In contrast, [HL7 V2](fhir-history.qmd) messages use their own proprietary encoding format, which cannot be parsed without a purpose-built software or custom code.
...
![The structure for FHIR Patient resource. <a href='https://hl7.org/fhir/R5/patient.html#resource' target='_blank'>https://hl7.org/fhir/R5/patient.html#resource</a>](images/fhir-r5-patient-structure.png){fig-alt="The structure for FHIR Patient resource. Go to https://hl7.org/fhir/R5/patient.html#resource for a text version."}
...
Below are examples of some of the most common element data types in FHIR.
...
![The structure for Patient.name, which is a HumanName. <a href='https://hl7.org/fhir/datatypes.html#HumanName' target='_blank'>https://hl7.org/fhir/datatypes.html#HumanName</a>](images/fhir-human-name-structure-r5.png){fig-alt="The structure for Patient.name, which is a HumanName. Go to https://hl7.org/fhir/datatypes.html#HumanName for a text version."}
...
Elements that can have more than one data type are called [**choice elements**](https://hl7.org/fhir/formats.html#choice). The `Patient.deceased[x]` element demonstrates some characteristics of a choice element.

-   The `[x]` in the element name is a placeholder for the data type that is actually used. Therefore, the `[x]` will never appear in an instance of Patient that's been populated with data -- it only appears in the specification when describing a choice element.

-   Therefore, one *and only one* of the following may appear in an instance of Patient: `Patient.deceasedBoolean` or `Patient.deceasedDateTime`. The FHIR specification indicates that these are the two valid types for `Patient.deceased[x]`.
...
![The first few rows of the structure table of the Patient resource, with an arrow indicating that Patient is a DomainResource.](images/fhir-r5-patient-domainresource.png){fig-alt="The first few rows of the structure table of the Patient resource, with an arrow indicating that Patient is a DomainResource."}
...
![The structure for FHIR observation resource. <a href='https://hl7.org/fhir/observation.html#resource' target='_blank'>https://hl7.org/fhir/observation.html#resource</a>](images/fhir-observation-structure.png){fig-alt="Observation structure with attributes status:code, code:CodeableConcept, subject:Reference(Patient), and value[x]. Go to https://hl7.org/fhir/observation.html#resource for a text version."}
...
:   Orders for medications for a patient. One of [several Medication domain resources](https://hl7.org/fhir/medicationrequest.html#bnr) which cover the workflow of ordering and administering medication.
...
[AllergyIntolerance](https://hl7.org/fhir/allergyintolerance.html)

:   A record of an allergy or intolerance.

[Practitioner](https://hl7.org/fhir/practitioner.html) / [PractitionerRole](https://www.hl7.org/fhir/practitionerrole.html)

:   Any individual providing healthcare or a related service, from physicians to receptionists to service animals. The `Practitioner` resource contains information on demographics, contact information, and qualifications independent of any organization. `PractitionerRole` includes an individual's particular role within and the services they provide for an organization.
