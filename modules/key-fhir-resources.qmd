...
[![A list of FHIR diagnostic resource types with their maturity levels.](images/fmm-levels.png){fig-align="center" fig-alt="Screenshot from the FHIR specification showing diagnostic resource types along with their maturity level which range from 0 to normative."}](https://hl7.org/fhir/resourcelist.html)
