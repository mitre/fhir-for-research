...
::: {.fancybox-figure data-fancybox="images/fhir-r4b-patient-structure.png" data-src="images/fhir-r4b-patient-structure.png" data-caption="The structure for FHIR Patient resource. <a href='https://hl7.org/fhir/R4B/patient.html#resource' target='_blank'>https://hl7.org/fhir/R4B/patient.html#resource</a>"}
[![Click to enlarge](images/fhir-r4b-patient-structure.png){fig-alt="The structure for FHIR Patient resource. Go to https://hl7.org/fhir/R4B/patient.html#resource for a text version."}](https://hl7.org/fhir/R4B/patient.html#resource)
:::
...
::: {.fancybox-figure data-fancybox="images/fhir-human-name-structure.png" data-src="images/fhir-human-name-structure.png" data-caption="The structure for Patient.name, which is a HumanName. <a href='https://hl7.org/fhir/datatypes.html#HumanName' target='_blank'>https://hl7.org/fhir/datatypes.html#HumanName</a>"}
[![Click to enlarge](images/fhir-human-name-structure.png){fig-alt="The structure for Patient.name, which is a HumanName. Go to https://hl7.org/fhir/datatypes.html#HumanName for a text version."}](https://hl7.org/fhir/datatypes.html#HumanName)
:::
...
::: {.fancybox-figure data-fancybox="images/fhir-r4b-patient-domainresource.png" data-src="images/fhir-r4b-patient-domainresource.png" data-caption="The first few rows of the structure table of the Patient resource, with an arrow indicating that Patient is a DomainResource."}
![Click to enlarge](images/fhir-r4b-patient-domainresource.png){fig-alt="The first few rows of the structure table of the Patient resource, with an arrow indicating that Patient is a DomainResource."}
:::
