...
![The CDIS workflow uses FHIR to simplify the process of creating a registry from EHR data.](images/cheng-fhir-shortcut.png){alt="The CDIS workflow uses FHIR to simplify the process of creating a registry from EHR data. From Cheng 2021."}
...
<!--Right navigation arrow at bottom points to 'Synthea Overview' but should be 'Introduction Webinar' -->
