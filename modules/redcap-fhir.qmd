...
![The CDIS workflow uses FHIR to simplify the process of creating a registry from EHR data.](images/cheng-fhir-shortcut.png){fig-alt="Diagram of data flowing directly from the EHR to REDCap, bypassing a data warehouse and flat file, saving time and effort."}
