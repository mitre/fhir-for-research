...
6.  [Install Python 3](https://www.python.org/downloads/macos/)
    -   Verify install worked with `python --version` in your Terminal, which should produce a version number
7.  [Clone](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository) the relevant GitHub repository to your local computer
...
9.  Open RStudio, go to "File \> Open Project...", and navigate to the folder of your cloned repo. You should see a `fhir-for-research.Rproj` file in this folder -- if you do, that's the right folder.
10. Run `renv::restore()` in the R Console to load all the R dependencies
