...
-   [SMART on FHIR](/modules/new-smart-on-fhir.qmd) provides a framework that allows developers to create secure healthcare applications that can run on any EHR system supporting the FHIR standard.
