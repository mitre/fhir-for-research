...
learning_objectives:
  - question: What role does FHIR play in health data interoperability?
    answer: FHIR is the ubiquitous specification governing interoperability of health systems. This is driven by regulation in the US and FHIR's pragmatic implementation-first approach.
  - question: Why is FHIR relevant for research?
...
<!-- could hide the answers in dropdowns so readers can think before revealing  -->

<!-- consider linking each role mentioned back to the roles page for quick refresher/navigation -->

## EHRs and interoperability

<!-- could spell out accronyms consistently when used initially, like with HIMSS, ONC, FHIR -->
...
<!-- bolded some key terms for clarity  -->
