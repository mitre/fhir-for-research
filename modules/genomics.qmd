...
# Genomics Standardization with FHIR

[Translational medicine](https://www.sciencedirect.com/science/article/abs/pii/B9780323898249000021 "What is translational medicine?") and [precision medicine](https://medlineplus.gov/genetics/understanding/precisionmedicine/definition/ "What is precision medicine?") involves both genomic data and clinical data in order to derive actionable insights that can be applied at the point of care. This involves collecting and harmonizing data sourced from both bioinformatics pipelines as well as clinical applications that include electronic health records, laboratory information systems, and other specialty systems.

Accomplishing these tasks are challenging as lack of exchange standards that satisfy clinical and genomic data pose a significant barrier to the broad adoption of genomic data for clinical use for diagnosis, treatment, and monitoring. This results in bespoke structural and semantic mappings that make the whole process cumbersome and not scalable.

Moreover, bioinformatics has a "big data" problem. The volume, variety, veracity, and velocity associated with the breadth and depth of genomic data complicate its use by providers and researchers.
...
## HL7 Genomic-related FHIR Specifications

### FHIR Genomics Reporting Implementation Guide

The [HL7 FHIR Genomics Reporting Implementation Guide](http://hl7.org/fhir/uv/genomics-reporting/index.html) (GRIG) provides guidance for a standardized representation of genomics data elements leveraging the FHIR framework of resources and operations, optimized for the genomic data exchange for clinical and research-oriented genomic use cases. Most of the standards development work in the CGWG is in this guidance.
...
[![](images/genomics-general-report-overview.png){width="434"}](http://hl7.org/fhir/uv/genomics-reporting/general.html#genomics-report)
...
[vcf2fhir](https://bmcbioinformatics.biomedcentral.com/articles/10.1186/s12859-021-04039-1) is a utility which converts VCF files into HL7 FHIR format, conforming to the HL7 FHIR GRIG. It is open-sourced and available on github [here](https://github.com/elimuinformatics/vcf2fhir "vcf2fhir github repository").
...
CGWG is is the author and steward of the [FHIR Genomics Reporting Implementation Guide](http://hl7.org/fhir/uv/genomics-reporting/STU2/), a FHIR-based specification for the exchange of genomics reporting elements.
