...
This module is meant for technical users who are interested understanding the architecture of CDS Hooks by reviewing an example CDS Service. Please be familiar with [SMART on FHIR](new-smart-on-fhir.qmd) and read the [CDS Hooks introduction](new-cds-hooks-intro.qmd) before continuing.
