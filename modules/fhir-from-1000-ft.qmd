...
<!-- if it's intended as connect parts, consider changing the page titles to indicate part 1/part 2 and then can reduce the following blurb  -->
...
<!-- is it possible when linking to jump directly to the relevant content (like to the flag, card. definitions directly)? If not consider copying or moving that piece here for ease of access -->
