...
::: {.fancybox-figure data-fancybox="images/R4_Patient.png" data-src="images/R4_Patient.png" data-caption="<a href='https://www.hl7.org/fhir/R4B/patient.html' target='_blank'>https://www.hl7.org/fhir/R4B/patient.html</a>"}
[![Click to enlarge](images/R4_Patient.png){fig-alt="Screenshot of Resource Contents table of the Patient resource in the FHIR R4B specification"}](images/R4_Patient.png)
:::
