...
The standards development process requires walking a fine line between adoptibility and thoroughness. HL7 describes the balance of the [standards process](https://confluence.hl7.org/display/HL7/Understanding+the+Standards+Process#:~:text=HL7%20ensures%20that%20all%20content,help%20to%20retain%20institutional%20knowledge):

> Spend too little time and energy and the standard is unlikely to be fit for purpose or see much adoption.  Take too long or require too much investment and the 
community will move on before the specification is declared “fit for use”.
...
- **Implementation**: greater visibility prevents standards from being developed in isolation. Successful implementation is more likely since there are many opportunities for the potential future implementators to offer input throughout the balloting process
...
Two research-related IGs that are undergoing the HL7 balloting process:
...
The next step in the [balloting process](https://confluence.hl7.org/display/HL7/HL7+Balloting) is to begin development of an IG. There are four levels of ballots:
...
4. **Normative**: this stage is the final ballot level and once the requirements are meant, IGs at this level are considered to be authoritative. A high level of consensus is required to meet the normative status since any changes are binding.
...
- Join the [chat.fhir.org](#chat-fhir-org) workspace, and particularly the [#Ballot-QA](https://chat.fhir.org/#narrow/stream/179257-Ballot-QA) stream to read previoues questions and answers or ask new questions. 
- Connect with others in the HL7 community that have worked on balloted specifications, either through [chat.fhir.org](chat.fhir.org) or through the Confluence work space. The community is vast and friendly; asking someone for advice may save you from sifting through Confluence to find the answer.