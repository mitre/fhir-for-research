...
-   [Argonauts](https://www.fhir.org/guides/argonaut/): EHR vendor-led organization establishing EHR API specifications
-   [CARIN Alliance](https://www.carinalliance.com/): Consumer-facing use cases
-   [CodeX](https://www.hl7.org/codex/): Standardizing cancer data
-   [Da Vinci](https://www.hl7.org/about/davinci/): Establishing a process for addressing payer use cases and value-based care delivery
...
### Considerations for the HL7 balloting process
...
There are also a number of factors to remember when choosing to ballot with HL7: - **Complexity**: the ballot schedule requires careful planning to ensure milestones are met and ballots are not delayed. This can be daunting for newcomers. - **Time**: The HL7 balloting timeline is fixed. New implementation guides must be proposed \~7 months ahead of time, updates to existing ballots must be filed \~2 months ahead of time. - **Reconciliation**: Once you have successfully balloted your implementation guide, you will need to reconcile any negative feedback received before publishing. This process can take months, and up to a year depending on the complexity and amount of feedback received.
