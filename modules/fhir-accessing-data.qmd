...
This URL is used to construct an HTTP API request, which typically takes the following form:
...
If you are interested in using the FHIR API to access data, you may want to review the [general FHIR API documentation](https://www.hl7.org/fhir/http.html) and the documentation specific to the [`search` interaction](https://www.hl7.org/fhir/search.html) in the FHIR specification.
