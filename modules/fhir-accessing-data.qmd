...
-   The modules converting from [FHIR to tabular format](tabular-from-fhir.qmd) if you are interested in extracting data from a FHIR server for analysis in software like R or Python/Pandas.
