...
REDCap, a survey tool that can be used with EHRs in the clinical workflow, can also be used with FHIR. For more information on using REDCap with FHIR, please see the [introductory REDCap page](redcap-example.qmd).
...
-   REDCap
    -   The [REDCap examples page](redcap-example.qmd)
