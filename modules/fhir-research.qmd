...
-   @zong2021 used FHIR to automatically fill case report forms for a colorectal cancer clinical trial. They were able to successfully extract a portion of the data needed to fill case report forms with 98.5% positive predictive value and 96.2% sensitivity using clinical records from 331 Mayo Clinic patients.
