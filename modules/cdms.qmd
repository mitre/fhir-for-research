...
![Diagram showing the structure of the OMOP CDM. From @book_of_ohdsi.](images/image-1041728868.png){alt="caption" fig-alt="Diagram showing the structure of the OMOP CDM."}
...
[![Diagram showing the structure of the Sentinel CDM. From <https://www.sentinelinitiative.org/methods-data-tools/sentinel-common-data-model>.](images/cdms_sentinel.png){.column-page-right fig-alt="Diagram describing the contents of the Sentinel CDM."}](https://www.sentinelinitiative.org/methods-data-tools/sentinel-common-data-model)
...
[![Diagram showing the structure of the PCORnet CDM v6.1. From @pcornet_cdm_6.1.](images/cdms_pcornet.png){.column-page-right fig-alt="Diagram showing the structure of the PCORnet CDM v6.1."}](https://pcornet.org/wp-content/uploads/2023/04/PCORnet-Common-Data-Model-v61-2023_04_031.pdf)
...
[![Diagram showing the i2b2 "star schema", from @i2b2_wiki_star_schema.](images/image-1891753576.png){fig-alt="Diagram showing the i2b2 \"star schema\"."}](https://community.i2b2.org/wiki/display/BUN/2.+Quick+Start+Guide)
