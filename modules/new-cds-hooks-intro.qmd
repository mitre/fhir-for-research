...
CDS Hooks are a feature within the HL7 [FHIR](fhir-from-10000-ft.qmd) standard, and is designed to be easily used with FHIR and [SMART on FHIR](new-smart-on-fhir.qmd).
...
An example of a research-focused application leveraging CDS Hooks can be found here: [Automated Clinical Trial Cohort Definition and Evaluation with CQL and CDS-Hooks](https://doi.org/10.3233/shti240028) \[_sic_\].
...
-   **Definition**: A CDS Service is a web service that listens for specific hooks and provides decision support in response. It processes the clinical context provided by the EHR (or "CDS Client") and returns actionable information in the form of CDS Cards.
...
-   **Interoperability and Standards-Based**: Built on open standards like RESTful APIs and FHIR, CDS Hooks ensures broad compatibility across different EHR systems, promoting interoperability and ease of implementation in diverse healthcare settings.
...
-   HL7 International. "CDS Hooks." Available at: [cds-hooks.hl7.org](https://cds-hooks.hl7.org)
-   SMART Health IT. "SMART on FHIR." Available at: [smarthealthit.org](https://smarthealthit.org)
