...
CDS Hooks are a feature within the HL7 [FHIR](fhir-from-10000-ft.qmd) standard, and is designed to be easily used with FHIR and [SMART on FHIR](smart-on-fhir-intro.qmd).
