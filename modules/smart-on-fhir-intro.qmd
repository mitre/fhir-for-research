...
learning_objectives:
  - question: Restate how SMART on FHIR supports research with data in EHRs.
    answer: SMART on FHIR can help researchers work with multiple institutions' EHRs with a build once and repurpose application.
