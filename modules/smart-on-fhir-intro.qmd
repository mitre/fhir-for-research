...
<!--Left navigation arrow at bottom points to 'FHIR Resources' but should be 'Genomics Data Standardization with FHIR' -->

<!--Right navigation arrow at bottom points to 'Reading IGs' but should be 'Technical Details' -->
